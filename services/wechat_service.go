...
func ParsePostMsg(c *gin.Context) (*RecMsg, []byte, error) {
	...
	if len(string(body)) == 0 {
		fmt.Println("body length is 0")
		return nil, nil, errors.New("body length is 0")
	}
	return &xmlMsg, body, nil
}

func HandleTextMsg(c *gin.Context, body []byte) {
	msg := RecTextMsg{}
...
func HandleVoiceMsg(c *gin.Context, body []byte) {
	msg := RecVoiceMsg{}
	_ = xml.Unmarshal(body, &msg)
...
func HandleEventMsg(c *gin.Context, body []byte) {
	msg := RecEventMsg{}
	_ = xml.Unmarshal(body, &msg)
...
func HandleDefaultMsg(c *gin.Context) {
