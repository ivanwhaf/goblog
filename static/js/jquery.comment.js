(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header><img src='"+obj.avatar+"'></header><div class='comment-right'><h3>"+obj.replyName+"</h3>"
				+"<div class='comment-content-header'><span>"+obj.commentDate+"</span>";
		...
		if(typeof(obj.platform) != "undefined" && obj.platform !== ""){
			el =el+"<span> 来自:"+obj.platform+"</span>";
		}
		
		if(typeof(obj.browser) != "undefined" && obj.browser !== ""){
			el = el + "<span> "+obj.browser+"</span>";
		}
